...
# KonIQ
koniq_csv_file = "data/koniq/koniq10k_distributions_sets.csv"
koniq_image_dir = "data/koniq/1024x768"
# CLIVE
clive_mat_dir = 'data/ChallengeDB_release/Data/AllImages_release.mat'
clive_score_file = 'data/ChallengeDB_release/Data/AllMOS_release.mat'
clive_img_dir = 'data/ChallengeDB_release/Images'
# LIVEFB
livefb_csv_file = "data/livefb_database/labels_image.csv"
livefb_img_dir = "data/livefb_database"
# SPAQ
spaq_csv_file = "data/spaq/MOS and Image attribute scores.xlsx"
spaq_img_dir = "data/spaq/SPAQ/TestImage"
...
class CLIVEDataset(Dataset):
    def __init__(self, mat_file, root_dir,score_file, transform=transform_in_the_wild):
        ...
        self.transform = transform
# Skip the first 7 training images
